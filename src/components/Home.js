  ...
  return (
    <div className='home-container'>
        ...
        <div className='home-content-box'>
            ...
            <div className='blah-blah-1'>
                <p className='category-description'>I have been playing electric bass for many years involving diff styles such as prog, funk, fusion, hip hop, metal, and more</p>
                <p className='category-description'>Check out some projects that I have worked on</p>
